(() => {
    ...
    function initSliders() {
        if (document.querySelector(".sale__slider")) new core(".sale__slider", {
            ...
            navigation: {
                prevEl: ".sale__arrows-prew",
                nextEl: ".sale__arrows-next"
            }
        });
        if (document.querySelector(".slider-products__slider")) new core(".slider-products__slider", {
            ...
            navigation: {
                prevEl: ".slider-products__arrow-prew",
    ...
    window.addEventListener("click", (e => {
        ...
        console.log(click);
        if (innerWidth >= 1200) if (!click) buttonSearch.classList.remove("active"); else buttonSearch.classList.add("active");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
